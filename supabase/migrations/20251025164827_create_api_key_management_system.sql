/*
  ...
  1. New Tables
    - `api_keys`
      - Stores user API keys with encryption
      - Tracks usage, priority, and context
    
    - `api_key_usage_logs`
      - Logs all API key usage for analytics
    
    - `api_key_selection_rules`
      - Custom rules for intelligent key selection

  2. Security
    - Enable RLS on all tables
    - Users can only access their own keys and logs
